...
export default {
  ...
  run(f, ctx) {
    ...
    if (description == null) {
      return judge(
        [{ entity: 'description', expected: '<meta name="description">', actual: 'тега нет' }],
        this.severity,
      );
    }
    if (!description) {
      return judge([{ entity: 'description', expected: 'непустое описание', actual: 'пустой content' }], this.severity);
    }
