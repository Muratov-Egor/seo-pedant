...
import links from './seo/15-links.mjs';
import structuredData from './seo/16-structured-data.mjs';
import uniqueness from './seo/17-uniqueness.mjs';
import textUniquenessExternal from './seo/18-text-uniqueness-external.mjs';
import ssr from './seo/19-ssr.mjs';
import consoleErrors from './seo/20-console-errors.mjs';
import mobile from './seo/21-mobile.mjs';
import performance from './seo/22-performance.mjs';
